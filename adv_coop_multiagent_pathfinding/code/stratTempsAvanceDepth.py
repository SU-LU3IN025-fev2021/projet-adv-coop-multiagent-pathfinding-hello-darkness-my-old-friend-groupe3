...
class temporal_A_D(Strategy):
    ...
    def execute(self):
        ...
        if self.verbose:
            print("Temps total pour la récupération de toutes les fioles : ", it)
            if self.nbPlayers == 2:        
                print("Joueur", j,"a gagné")  
            else:
                print("Equipe du joueur", j,"a gagné")
        
    def is_finished(self):
        """
        Test si tous les joueurs sont déjà arrivés à leurs respectives fioles.
        """
